...
clang++ -std=c++20 -O3 bin/gen_graph -Iinclude src/main.cpp src/find_odd_holes.cpp src/utils.cpp src/iterative_modification_heuristic.cpp src/gen_c5_free.cpp
